...
def calculo_utilidades():
    for i in df_suelos.index:
        DP_alto_viejo = choice[0]*df_suelos.loc[i][1]+choice[1]*df_suelos.loc[i][3]+(choice[3]+choice[4])*df_suelos.loc[i][6]+(choice[5]+choice[6])*df_suelos.loc[i][4]+choice[7]*df_suelos.loc[i][2]
        DP_alto_joven = choice[0]*df_suelos.loc[i][1]+choice[1]*df_suelos.loc[i][3]+choice[3]*df_suelos.loc[i][6]+(choice[5]+choice[6])*df_suelos.loc[i][4]+choice[7]*df_suelos.loc[i][2]
        DP_bajo_viejo = choice[0]*df_suelos.loc[i][1]+(choice[1]+choice[2])*df_suelos.loc[i][3]+(choice[3]+choice[4])*df_suelos.loc[i][6]+choice[5]*df_suelos.loc[i][4]+choice[7]*df_suelos.loc[i][2]
        DP_bajo_joven = choice[0]*df_suelos.loc[i][1]+(choice[1]+choice[2])*df_suelos.loc[i][3]+choice[3]*df_suelos.loc[i][6]+choice[5]*df_suelos.loc[i][4]+choice[7]*df_suelos.loc[i][2]
        matrix[(i,'a')]=DP_alto_viejo,DP_alto_joven,DP_bajo_viejo,DP_bajo_joven
    for i in df_suelos.index:
        DP_alto_viejo = choice[0]*df_suelos.loc[i][1]+choice[1]*df_suelos.loc[i][3]+(choice[3]+choice[4])*df_suelos.loc[i][6]+(choice[5]+choice[6])*df_suelos.loc[i][4]+choice[7]*df_suelos.loc[i][2]
        DP_alto_joven = choice[0]*df_suelos.loc[i][1]+choice[1]*df_suelos.loc[i][3]+choice[3]*df_suelos.loc[i][6]+(choice[5]+choice[6])*df_suelos.loc[i][4]+choice[7]*df_suelos.loc[i][2]
        DP_bajo_viejo = choice[0]*df_suelos.loc[i][1]+(choice[1]+choice[2])*df_suelos.loc[i][3]+(choice[3]+choice[4])*df_suelos.loc[i][6]+choice[5]*df_suelos.loc[i][4]+choice[7]*df_suelos.loc[i][2]
        DP_bajo_joven = choice[0]*df_suelos.loc[i][1]+(choice[1]+choice[2])*df_suelos.loc[i][3]+choice[3]*df_suelos.loc[i][6]+choice[5]*df_suelos.loc[i][4]+choice[7]*df_suelos.loc[i][2]
        matrix[(i,'b')]=DP_alto_viejo,DP_alto_joven,DP_bajo_viejo,DP_bajo_joven
